...
```
curl -H "Cache-Control: no-cache" -s https://raw.githubusercontent.com/simon-project/esd/refs/heads/main/esd.sh  | { content=$(cat); echo "$content" | md5sum | grep -q 9561c19237b19ea29b4f769cd1d30ae9 && echo "$content" | bash || echo "MD5 checksum mismatch. Will not be executed."; }
```
